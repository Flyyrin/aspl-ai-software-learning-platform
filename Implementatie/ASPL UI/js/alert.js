...
(function ($) {
    $.alert_ext = {
        ...
        defaults: {
            ...
            type: 'info',  // 提示类型
            position: ['center', [0.35, 0]], // 位置,第一个写位置，英文哦，后面是偏移，如果是1跟-1之间为百分比
            title: false, // 标题
            close: '',   // 需绑定关闭事件滴按钮
            speed: 'normal',   // 速度
            isOnly: true, //是否只出现一个
        ...
        // 提示框模版
        tmpl: '<div class="alert alert-dismissable ${State}"><button type="button" class="close d-none" data-dismiss="alert" aria-hidden="true">&times;</button><h4 style="white-space: nowrap;">${Title}</h4><p class="text-center m-0">${Content}</p></div>',
